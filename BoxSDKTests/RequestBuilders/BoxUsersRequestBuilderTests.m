...
- (void)testThatLoginInBodyDictionaryWhenPropertyIsSet
{
    ...
    builder.login = login;
    XCTAssertEqualObjects(@{BoxAPIObjectKeyLogin : login}, builder.bodyParameters, @"login should be included in body dictionary when set");
}
...
- (void)testThatRoleInBodyDictionaryWhenPropertyIsSet
{
    ...
    builder.role = role;
    XCTAssertEqualObjects(@{BoxAPIObjectKeyRole : role}, builder.bodyParameters, @"role should be included in body dictionary when set");
}
...
- (void)testThatLanguageInBodyDictionaryWhenPropertyIsSet
{
    ...
    XCTAssertEqualObjects(@{BoxAPIObjectKeyLanguage : language}, builder.bodyParameters, @"language should be included in body dictionary when set");
}
...
- (void)testThatIsSyncEnabledInBodyDictionaryWhenPropertyIsSet
{
    ...
    XCTAssertEqualObjects(@{BoxAPIObjectKeyIsSyncEnabled : isSyncEnabled}, builder.bodyParameters, @"isSyncEnabled should be included in body dictionary when set");
}
...
- (void)testThatJobTitleInBodyDictionaryWhenPropertyIsSet
{
    ...
    XCTAssertEqualObjects(@{BoxAPIObjectKeyJobTitle : jobTitle}, builder.bodyParameters, @"jobTitle should be included in body dictionary when set");
}
...
- (void)testThatPhoneInBodyDictionaryWhenPropertyIsSet
{
    ...
    builder.phone = phone;
    XCTAssertEqualObjects(@{BoxAPIObjectKeyPhone : phone}, builder.bodyParameters, @"phone should be included in body dictionary when set");
}
...
- (void)testThatAddressInBodyDictionaryWhenPropertyIsSet
{
    ...
    XCTAssertEqualObjects(@{BoxAPIObjectKeyAddress : address}, builder.bodyParameters, @"address should be included in body dictionary when set");
}
...
- (void)testThatSpaceAmountInBodyDictionaryWhenPropertyIsSet
{
    ...
    XCTAssertEqualObjects(@{BoxAPIObjectKeySpaceAmount : spaceAmount}, builder.bodyParameters, @"spaceAmount should be included in body dictionary when set");
}
...
- (void)testThatTrackingCodesInBodyDictionaryWhenPropertyIsSet
{
    ...
    XCTAssertEqualObjects(@{BoxAPIObjectKeyTrackingCodes : trackingCodes}, builder.bodyParameters, @"trackingCodes should be included in body dictionary when set");
}
...
- (void)testThatStatusInBodyDictionaryWhenPropertyIsSet
{
    ...
    XCTAssertEqualObjects(@{BoxAPIObjectKeyStatus : status}, builder.bodyParameters, @"status should be included in body dictionary when set");
}
@end
